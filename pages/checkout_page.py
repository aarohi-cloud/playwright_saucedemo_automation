...
class CheckoutPage(BasePage):
    ...
    def fill_information(self, first_name: str, last_name: str, zip_code: str) -> None:
        ...
        self.safe_fill(self.page.locator(self.POSTAL_CODE_INPUT), zip_code)

    def continue_checkout(self) -> None:
        """Click continue button to proceed to checkout step two."""
        self.safe_click(self.page.locator(self.CONTINUE_BUTTON))
        self.page.wait_for_load_state("networkidle")

    def finish_order(self) -> None:
        """Click finish button to complete the order."""
        self.safe_click(self.page.locator(self.FINISH_BUTTON))
        self.page.wait_for_load_state("networkidle")
    ...
    def back_to_products(self) -> None:
        ...
        self.safe_click(self.page.locator(self.BACK_HOME_BUTTON))
        self.page.wait_for_load_state("networkidle")
